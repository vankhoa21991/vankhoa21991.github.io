...
app.config['MYSQL_DATABASE_PASSWORD'] = 'wolfyhappy10'
app.config['MYSQL_DATABASE_DB'] = 'Loginlist'
...
def signUp():
    ...
    if _name and _email and _password:
        ...
        cursor1.callproc('sp_createUser',(_name,_email,_hashed_password))
        ...
        return json.dumps({'html':'<span>Good data</span>'})
    else:
...
def validateLogin():
    try:
        ...
        # _hashed_password = generate_password_hash(_password)
        # q = check_password_hash(str(data[0][3]),_password)
        # json.dumps({_hashed_password})
